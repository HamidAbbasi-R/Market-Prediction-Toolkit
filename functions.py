...
def GetPriceData_Yfinance(symbol, start_time, end_time, timeframe):
...
def get_start_time(endTime, timeframe, Nbars):
    import re
...
def TrainHMM_hmmlearn(
    ...
    if random_transmat:
        ...
        main_diag = np.random.uniform(0.2, 0.9, hiddenStates)
    else:
